  ...
  createDefaultPreferences(): void {
    const defaultPreferences: { [key: string]: any } = {
      ...
      company_phone: {
        ...
        type: 'string',
        description: 'Primary contact phone number (UK format: +44 XX XXXX XXXX)',
        group: 'General',
        required: true,
        validation: {
      ...
      phone_format: {
        ...
        value: 'UK',
        type: 'select',
        options: ['UK (+44)', 'US (+1)', 'International'],
        description: 'Default phone number format for the application',
        group: 'Display',
        required: true,
      },
      currency: {
      ...
      time_format: {
        ...
        type: 'select',
        options: ['24h', '12h'],
        description: 'Format for displaying times (24h recommended for UK business)',
        group: 'Display',
        required: true,
      },
      default_language: {
        ...
        description: 'Default language and locale for the application',
        group: 'Display',
        required: true,
      },
